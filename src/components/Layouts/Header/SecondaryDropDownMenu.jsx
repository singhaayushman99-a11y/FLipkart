    ...
    const navs = [
        {
            ...
            redirect: "https://www.MMIC.com/communication-preferences/push",
        },
        {
            title: "Sell on MMIC",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.MMIC.com/sell-online",
        },
        {
            title: "24x7 Customer Care",
            icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.MMIC.com/helpcentre",
        },
        {
            title: "Advertise",
            icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://advertising.MMIC.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.MMIC.com/mobile-apps",
        },
    ]
